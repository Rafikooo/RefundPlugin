...
final readonly class RemainingTotalProvider implements RemainingTotalProviderInterface
{
    /** @param ServiceProviderInterface<RefundUnitTotalProviderInterface> $refundUnitTotalProvider */
